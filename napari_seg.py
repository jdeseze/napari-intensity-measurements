...
# =============================================================================
# #%% trying to add tensorflow model to napari as a button
# from tensorflow.keras import models
# import cv2
# from magicgui import magicgui
# 
# curr_mod = models.load_model(r'C:\Users\Jean\OneDrive - INSTITUT CURIE\Documents\Python\lionel\single_mam_cell-ep50-bs4_date05-10-2022-10-03')
# 
# def seg_unet(img,thr):
#     img = img[0]
...
#     pred = (curr_mod.predict(img)[0][:,:,0]*255).astype('uint8')
#     ret, thresh = cv2.threshold(pred,thr,255,0)
#     
#     return (thresh[np.newaxis,:,:])
# 
# @magicgui(call_button='Segment Unet',
#           thr={"widget_type": "FloatSlider",'min':0, 'max': 255,'step':1.0},
#           )
# def segment_unet(data:napari.types.ImageData,
#             thr=240,
#             ):
#     
#     seg = da.map_blocks(seg_unet,data,thr=thr)#bg=bg,init_median=init_median)
#     #print(data[0])
#     viewer.add_image(seg,name='segmented',opacity=0.2)    
# 
# if __name__ == "__main__":
#     viewer.window.add_dock_widget(segment_unet)
# =============================================================================
